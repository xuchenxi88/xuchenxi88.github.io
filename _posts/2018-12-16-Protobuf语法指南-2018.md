...
## <font color=#DC143C>1/</font> 指定字段类型
...
## <font color=#DC143C>2/</font> 分配标识号
...
## <font color=#DC143C>3/ </font> 指定字段规则
所指定的消息字段修饰符必须是如下之一：
...
## <font color=#DC143C>4/ </font>添加更多消息类型
...
```	
## <font color=#DC143C>6/ </font>从.proto文件生成了什么？
...
## <font color=#DC143C>7/ </font>标量数值类型
...
## <font color=#DC143C>8/ </font>Optional的字段和默认值
...
## <font color=#DC143C>4/ </font> 更新一个消息类型
...
## <font color=#DC143C>6/ </font> 嵌套的扩展
可以在另一个类型的范围内声明扩展，如：
...
## <font color=#DC143C>7/ </font> 选择可扩展的标量符号
...
## <font color=#DC143C>1/ </font> 使用Oneof
...
## <font color=#DC143C>2/ </font> 向后兼容性问题
...
## <font color=#DC143C>1/ </font> 包及名称的解析
...
## <font color=#DC143C>1/ </font> 自定义选项
